...
In this assignment, we read in two directories of spam and ham (non-spam) emails, combined and labeled them in a single corpora, and trained models to predict the classification of a holdout set of the emails. 
