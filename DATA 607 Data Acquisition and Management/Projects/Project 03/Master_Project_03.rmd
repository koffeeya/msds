...
>>>>>>> 89ffb34a0acb3793860947017a4ff35d3369956c
...
Used mutate function to create new variables for Tool Skills and preserve existing ones from summary; turned on case insensitivity
...
ggplot(softskills2,aes(x=reorder(variable, value), y=value)) + 
  geom_bar(stat='identity',fill="green") + 
  xlab('') + 
  ylab('Frequency') + 
