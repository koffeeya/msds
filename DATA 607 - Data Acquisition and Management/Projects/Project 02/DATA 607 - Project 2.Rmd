...
In this project, I imported three CSV datasets, tidied them, and answered questions about them. The datsets and questions were chosen by my classmates and posted in the DATA 607 BlackBoard forum.


### Datasets

Here are links to the datsets I tidied and the classmate who posted them.

1. [**U.S. Marriage and Divorce Rates**]("https://github.com/xiaoxiaogao-DD/DATA607-Project1/blob/master/national_marriage_divorce_rates_00-16.csv"), posted by Jiadi Li
...
The dataset contains two tables: one that describes the number of marriages per year in the U.S population from 2000 -- 2016, and one that describes the number of divorces and annulments during the same period.
...
Then, I converted hours column into minutes using the `mutate` function.
...
Finally, I added together the new hours spent column with the minutes column to get the total number of minutes spent on the activity. I removed the leftover `Hours_Spent`, `Minutes_Spent`, and `Total` columns.
...
Since there are 1,440 minutes in a day, we can calculate the time spent on each activity as a percentage.
...
The second question was very broad, so I decided to narrow it down to comparing how much time men and women in different countries spend on specific activities.


**Household and Family Care**

First, I filtered the dataframe by the "Household and Family Care" activity type, and grouped the data by country and sex. Then, I created a summary of the data the added up time spent.
...
I thought I would try a new kind of plot to compare attendance at the elementary school and secondary school levels -- a **population plot**. To make this kind of plot, I had to change the percentage attendance at the elementary school level to be negative.
...
# Specify range and markers of y-axis
brks <- seq(-100, 100, 25)

#Specify labels of y-axis and take the absolute value to keep them positive
...
I did some digging and it seems like Washington is [still struggling]("https://www.seattletimes.com/education-lab/high-numbers-of-washington-students-miss-school-which-hinders-learning-for-all/") with school attendance -- as of 2014, it is still ranked among the lowest in the nation.
