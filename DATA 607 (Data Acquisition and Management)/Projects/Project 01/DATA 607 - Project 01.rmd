...
In this project, I was given a [**text file**]("https://goo.gl/9oQpb8") with chess tournament results where the information had some structure. My goal was to create an R Markdown file that generates a **CSV file** with the following information for all players:
...
[Here is a link]("https://goo.gl/V5CXQj") to the CSV file I created.
