---
title: 'DATA 606, Ch. 5 Lab -- Inference for numerical data'
output:
  html_document:
    css: ./lab.css
    highlight: pygments
...
1.  What are the cases in this data set? How many cases are there in our sample?
    ...
    The cases in this dataset are 1000 births recorded in North Carolina.
...
`length`.
    ...
    Yes, the conditions for inference are satisfied.
    
    The sample is random, so the observations are independent.
    
    The sample size is above 30.
    
    The sample does not appear to be strongly skewed in one direction.
...
smoking and non-smoking mothers are different.
    ...
    * Null hypothesis: The difference between the average weights of babies born to smoking and non-smoking mothers is zero.
    
    * Alternate hypothesis: The difference between the average weights of babies born to smoking and non-smoking mothers is not zero.
...
omit the `x` variable from the function.**
    ...
    The 95% confidence interval for the `weeks` variable is ( 38.1528 , 38.5165 ). This means that we are 95% confident that the average length of pregnancy in the population of NC mothers is between 38.2 and 38.5 weeks.
...
to the function: `conflevel = 0.90`.**
    ...
    At the 90% confidence level, the average length of pregnancy in the population is between 38.2 and 38.5 weeks.
...
younger mothers is different than the average weight gained by mature mothers.**
    ...
    The p-value is 0.1686, which is greater than the alpha, which is 0.05. This provides evidence to accept the null hypothesis as true -- that the average weight gained by mature moms and younger moms are not different.
...
mothers. Use a method of your choice, and explain how your method works.**
    ...
    I created two new dataframes based on subsets of the `mature` column in the original data. Then, I took a summary of the `fage` column in each dataframe to see the range.
    
    It appears that the age cutoff for a "mature mom" is **26 years old**. However, there are moms older than 26 in the "younger mom" category too.
...
plain language.**
    ...
    Question: Is the average age of non-white mothers significantly lower than the average age of white mothers?
  
    Yes. The mean age of non-white mothers is 29 years old, and the mean age of white mothers is 31 years old. The p-value is 0.0032, which is smaller than the alpha, which is 0.05. This provides evidence to accept the alternate hypothesis as true -- that on average, the age of a non-white mother in the population is younger than the age of a white mother.
